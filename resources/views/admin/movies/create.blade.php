            ...
            <div class="row mb-3">
                ...
                <div class="col-6">
                    ...
                    <input type="time" name="duration" id="duration"
                        class="form-control @error('duration')is-invaid @enderror" value="{{ old('duration') }}">
                    @error('duration')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input type="text" name="genre" id="genre"
                        class="form-control @error('genre')is-invaid @enderror" value="{{ old('genre') }}">
                    @error('genre')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="col-6">
                    ...
                    <input type="text" name="director" id="director"
                        class="form-control @error('director')is-invaid @enderror" value="{{ old('director') }}">
                    @error('director')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input type="number" name="age_rating" id="age_rating"
                        class="form-control @error('age_rating')is-invaid @enderror" value="{{ old('age_rating') }}">
                    @error('age_rating')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="col-6">
                    ...
                    <input type="file" name="poster" id="poster"
                        class="form-control @error('poster')is-invaid @enderror" value="{{ old('poster') }}">
                    @error('poster')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
