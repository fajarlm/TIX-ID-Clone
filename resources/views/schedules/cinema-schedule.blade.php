...
@section('content')
        ...
        <div class="card-body">
            ...
            @foreach ($schedules as $schedule)
                <div class="my-2">
                    <div class="d-flex">
                        <div>
                            <img src="{{ asset('storage/' . $schedule['movie']['poster']) }}" alt=""  style="width: 150px; height: 200px">
                        </div>
                        <div class="ms-5 mt-4">
                            <table>
                                <tr>
    ...
    <div class="w-100 p-2 bg-light text-center fixed-bottom" id="wrapBtn">
        <a class="btn-primary" href="javascript:void(0)" id="btnTicket"><i class="fa-solid fa-ticket"></i> BELI
            TIKET</a>
    </div>
@endsection
...
@push('script')
    <script>
        ...
        function selectedHour(scheduleId, hourId, el) {
            ...
            //siapkan route
            let url = "{{ route('schedule.show_seats', ['scheduleId' => ':scheduleId', 'hourId' => ':hourId']) }}"
